      ...
      (err, row) => {
        ...
        db.get(
          ...
          (err2, managerRow) => {
            ...
            return sendReply('<:traverser:1400313375547850877> You must be the channel owner or a manager to disable soundboard.');
          }
        );
        ...
        async function disableSoundboard() {
          try {
            ...
            return sendReply('<:arcadiasboff:1384185071304445963> Disabled **Use Soundboard** permission for everyone in this voice channel.');
          } catch (err) {
