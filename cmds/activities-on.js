      ...
      (err, row) => {
        ...
        db.get(
          ...
          (err2, managerRow) => {
            ...
            return sendReply('<:discotoolsxyzicon:1448758684535488562> You must be the channel owner or a manager to enable activities.');
          }
        );
        ...
        async function enableActivities() {
          try {
            ...
            return sendReply('<:acradiaacton:1448782206138056796> Activities permission enabled for everyone in this voice channel.');
          } catch (err) {
