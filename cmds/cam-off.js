      ...
      (err, row) => {
        ...
        db.get(
          ...
          (err2, managerRow) => {
            ...
            return sendReply('<:traverser:1400313375547850877> You must be the channel owner or a manager to disable the camera.');
          }
        );
        ...
        async function disableCamera() {
          try {
            ...
            return sendReply('<:arcadiacamoff:1384186030592102461> Camera permission disabled for everyone in this voice channel.');
          } catch (err) {
