      ...
      (err, row) => {
        ...
        db.get(
          ...
          (err2, managerRow) => {
            ...
            return sendReply('<:discotoolsxyzicon:1448758684535488562> You must be the channel owner or a manager to disable the camera.');
          }
        );
        ...
        async function disableCamera() {
          try {
            ...
            return sendReply('<:arcadiacamoff:1448782170775621681> Camera permission disabled for everyone in this voice channel.');
          } catch (err) {
