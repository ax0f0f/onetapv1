...
module.exports = {
    ...
    async execute(message, args, client) {
        ...
        const titleText = new TextDisplayBuilder().setContent(`## @everyone @here  <:reportt:1448797160614133940> Bot Announcement: Pivot is Now Public!`);
        const introText = new TextDisplayBuilder().setContent(`> Great news! **Pivot** is now available for everyone to use.`);
        const featuresTitle = new TextDisplayBuilder().setContent(`### What I do:`);
        const featuresText = new TextDisplayBuilder().setContent(`I create temporary voice and text channels instantly. Just join the **"One Tap"** voice channel, and I'll give you a private room. As the room owner, you can use the control panel to manage it.`);
