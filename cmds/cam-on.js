      ...
      (err, row) => {
        ...
        db.get(
          ...
          (err2, managerRow) => {
            ...
            return sendReply('<:traverser:1400313375547850877> You must be the channel owner or a manager to enable camera.');
          }
        );
        ...
        async function enableCamera() {
          try {
            ...
            return sendReply('<:arcadiacamon:1384185720293560451> Enabled **Camera (Use Video)** permission for everyone in this voice channel.');
          } catch (err) {
